...
export default function Infos() {
    ...
    return (
        <div className="taxa">
            ...
            <p>Sua taxa metabólica basal é de <strong>{result} Kcal</strong>.</p><br />
            ...
            <p>Se deseja engordar deve seguir uma dieta com mais de <strong>{resultC} Kcal</strong> por dia.</p>
